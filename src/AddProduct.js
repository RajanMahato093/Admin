...
function AddProduct() {
  ...
  return (
    <div style={{display:'flex', flexDirection:'column',padding:'20px'}}>
      <form onSubmit={handle} style={{display:'flex', flexDirection:'column', height:'100vh', width:'30vw',alignItems:'center'}}>
        ...
        <button style={{width:'100px', marginTop:'20px'}}>ADD</button>
      </form>
    </div>
  )
}
